#GUIA 5 - Ejercicio 6
#-------------------
##Evalúe la función f(x) = sin(2pi*x) en 21 puntos equiespaciados en el intervalo [−1, 1].
##Calcule el polinomio interpolador de Lagrange y el trazador cúbico natural.
##Compare las gráficas de estas dos funciones con la de f(x) en el intervalo dado.
##Repita el mismo cálculo usando el siguiente conjunto de datos perturbados: f(xi) = sin(2πxi) + (−1)i+110−4
##y observe que el polinomio interpolador de Lagrange es más sensible a peque˜nas perturbaciones que el trazador cúbico
#-------------------
